...
export default function PrivacyPage() {
  return (
    <main id="main-content" className="policyPage">
      ...
      <section><h2>2. 보유 기간과 파기</h2><p>브라우저에 저장된 방문 표시값과 검토 메모는 이용자의 기기에만 남으며, 브라우저 데이터 삭제로 즉시 지울 수 있습니다. 서버의 방문 수는 개인을 식별할 수 없는 합계 수치이며, 서비스 운영 기간 동안만 보관하고 별도의 개인정보를 담지 않으므로 기간 경과에 따른 파기 대상 자체가 없습니다.</p></section>
      ...
      <section><h2>5. 이용자 권리와 문의</h2><p>이용자는 브라우저 저장 정보를 직접 열람·삭제할 수 있습니다. 서버는 개인을 식별하는 정보를 보유하지 않아 열람·정정·삭제·처리정지 요청의 대상이 되는 개인정보 자체가 없으나, 자료 오류·정정·삭제 요청 또는 개인정보 관련 문의는 아래 담당자에게 보내 주세요. 접수 내용을 확인해 필요한 조치를 안내합니다.</p><p><strong>개인정보 보호·자료 정정 담당: N의 생명과학</strong><br /><a href="https://www.instagram.com/n_life_science" target="_blank" rel="noreferrer">instagram.com/n_life_science</a></p><p>이 서비스의 조치가 충분하지 않다고 판단되면 아래 공식 기관에도 문의할 수 있습니다.</p><p>개인정보분쟁조정위원회 (privacy.go.kr / 국번없이 1833-6972)<br />개인정보침해신고센터 (privacy.kisa.or.kr / 국번없이 118)</p></section>
